...
efa_model <- '
  ...
  efa("efa")*f5 +
  efa("efa")*f6 +
  efa("efa")*f7 =~ REP_Q2 + REP_Q3 + REP_Q5 + REP_Q6 + REP_Q8 + 
                   REP_Q9 + REP_Q10 + REP_Q11 + REP_Q12 + 
                   REP_Q13 + REP_Q14 + REP_Q15 + REP_Q16 + 
                   REP_Q17 + REP_Q18 + REP_Q19 + REP_Q20_1 + 
                   REP_Q20_2 + REP_Q20_3 + REP_Q21
'

efa_fit <- efa(efa_model, 
               data = select(palem_sem, rep_q2:rep_q21), 
               nfactors = 1:7)
...
model_5mi <- ' 
  # measurement model
    ## dependent variables
      pt =~ Q101_1 + Q101_2 + Q101_3 + Q101_4 + Q101_5
      car =~ Q102_1 + Q102_2 + Q102_3 + Q102_4 + Q102_5
      bike =~ Q103_1 + Q103_2 + Q103_3 + Q103_4 + Q103_5
      walking =~ Q104_1 + Q104_2 + Q104_3 + Q104_4 + Q104_5
    ## mediation variables
      ease =~ Q94_1 + Q94_2 + Q94_3
      proximity =~ Q95_2 + Q95_3 + Q95_4
      fac1 =~ rep_q5 + rep_q6 + rep_q8 + rep_q9 + rep_q10 + rep_q12 + rep_q15 + rep_q20_2
      fac2 =~ rep_q7 + rep_q8 + rep_q10 + rep_q11 + rep_q12 + rep_q13 + rep_q14 + rep_q15 + rep_q16 + rep_q17
      fac3 =~ rep_q20_1 + rep_q20_2 + rep_q20_3
    ## indicators
      Q101_1 ~~ Q102_1 + Q103_1 + Q104_1
      Q102_1 ~~ Q103_1 + Q104_1
      Q103_1 ~~ Q104_1
      Q101_2 ~~ Q102_2 + Q103_2 + Q104_2
      Q102_2 ~~ Q103_2 + Q104_2
      Q103_2 ~~ Q104_2
      Q101_3 ~~ Q102_3 + Q103_3 + Q104_3
      Q102_3 ~~ Q103_3 + Q104_3
      Q103_3 ~~ Q104_3
      Q101_4 ~~ Q102_4 + Q103_4 + Q104_4
      Q102_4 ~~ Q103_4 + Q104_4
      Q103_4 ~~ Q104_4
      Q101_5 ~~ Q102_5 + Q103_5 + Q104_5
      Q102_5 ~~ Q103_5 + Q104_5
      Q103_5 ~~ Q104_5
  # structural model
    ease ~ se_educ + se_income
    proximity ~ se_educ + se_income + se_sub + se_secnd + se_periph + se_rural
    fac1 ~ ease + proximity + se_educ + se_income
    fac2 ~ ease + proximity + se_educ + se_income
    fac3 ~ ease + proximity + se_educ + se_income
    fac1 ~~ fac2 + fac3
    fac2 ~~ fac3
    pt ~ ease + proximity + fac1 + fac2 + fac3 + se_educ + se_income + se_sub + se_secnd + se_periph + se_rural
    car ~ ease + proximity + fac1 + fac2 + fac3 + se_educ + se_income + se_sub + se_secnd + se_periph + se_rural
    bike ~ ease + proximity + fac1 + fac2 + fac3 + se_educ + se_income + se_sub + se_secnd + se_periph + se_rural
    walking ~ ease + proximity + fac1 + fac2 + fac3 + se_educ + se_income + se_sub + se_secnd + se_periph + se_rural '
...
model_7mi <- ' 
  # measurement model
    ...
    ## mediation variables
      ease =~ Q94_1 + Q94_2 + Q94_3
      proximity =~ Q95_2 + Q95_3 + Q95_4
      fac1 =~ rep_q4 + rep_q7 + rep_q8 + rep_q9 + rep_q10 + rep_q11 + rep_q13 + rep_q14 + rep_q15 + rep_q20_2
      fac2 =~ rep_q9 + rep_q10 + rep_q12 + rep_q13 + rep_q14 + rep_q15
      fac3 =~ rep_q20_1 + rep_q20_2 + rep_q20_3
    ## indicators
      Q101_1 ~~ Q102_1 + Q103_1 + Q104_1
      Q102_1 ~~ Q103_1 + Q104_1
...
fit <- sem(model_5mi, data = palem_sem_cont, group = "genre")
